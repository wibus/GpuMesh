...
TetBoundary::TetBoundary() :
    ...
    _v0(-1, glm::dvec3(0, 0, 0) - TET_FIRST_MOMENT),
    _v1(-2, glm::dvec3(1, 0, 0) - TET_FIRST_MOMENT),
    _v2(-3, glm::dvec3(0.5, sqrt(3.0)/2, 0) - TET_FIRST_MOMENT),
    _v3(-4, glm::dvec3(0.5, sqrt(3.0)/6, sqrt(2.0/3)) - TET_FIRST_MOMENT),
