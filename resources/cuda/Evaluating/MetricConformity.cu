        ...
        uint cacheId)
{
    ...
    return ((*metricAt)((v0 + v1 + v2 + v3)/4.0f,  cacheId) * (-0.8f) +
            (*metricAt)(v0*H + v1*Q + v2*Q + v3*Q, cacheId) * 0.45f +
            (*metricAt)(v0*Q + v1*H + v2*Q + v3*Q, cacheId) * 0.45f +
            (*metricAt)(v0*Q + v1*Q + v2*H + v3*Q, cacheId) * 0.45f +
            (*metricAt)(v0*Q + v1*Q + v2*Q + v3*H, cacheId) * 0.45f);
}
