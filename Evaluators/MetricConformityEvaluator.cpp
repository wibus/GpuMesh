...
MeshMetric MetricConformityEvaluator::specifiedMetric(
        ...
        const MeshTet& tet) const
{
    ...
    MeshMetric Ms0 = specifiedMetric(sampler, vp[0], vp[1], vp[2], vp[3], tet.c[0]);
        ...
        const MeshPri& pri) const
{
    ...
    MeshMetric Ms0 = specifiedMetric(sampler, vp[0], vp[1], vp[2], vp[3], pri.c[0]);
    MeshMetric Ms1 = specifiedMetric(sampler, vp[0], vp[1], vp[2], vp[4], pri.c[1]);
    MeshMetric Ms2 = specifiedMetric(sampler, vp[0], vp[1], vp[2], vp[5], pri.c[2]);
    MeshMetric Ms3 = specifiedMetric(sampler, vp[0], vp[3], vp[4], vp[5], pri.c[3]);
    MeshMetric Ms4 = specifiedMetric(sampler, vp[1], vp[3], vp[4], vp[5], pri.c[4]);
    MeshMetric Ms5 = specifiedMetric(sampler, vp[2], vp[3], vp[4], vp[5], pri.c[5]);
        ...
        const MeshHex& hex) const
{
    ...
    MeshMetric Ms0 = specifiedMetric(sampler, vp[0], vp[1], vp[3], vp[4], hex.c[0]);
    MeshMetric Ms1 = specifiedMetric(sampler, vp[0], vp[1], vp[2], vp[5], hex.c[1]);
    MeshMetric Ms2 = specifiedMetric(sampler, vp[1], vp[2], vp[3], vp[6], hex.c[2]);
    MeshMetric Ms3 = specifiedMetric(sampler, vp[0], vp[2], vp[3], vp[7], hex.c[3]);
    MeshMetric Ms4 = specifiedMetric(sampler, vp[0], vp[4], vp[5], vp[7], hex.c[4]);
    MeshMetric Ms5 = specifiedMetric(sampler, vp[1], vp[4], vp[5], vp[6], hex.c[5]);
    MeshMetric Ms6 = specifiedMetric(sampler, vp[2], vp[5], vp[6], vp[7], hex.c[6]);
    MeshMetric Ms7 = specifiedMetric(sampler, vp[3], vp[4], vp[6], vp[7], hex.c[7]);
